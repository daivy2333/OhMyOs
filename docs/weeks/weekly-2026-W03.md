...
下面的那些还是过于晦涩、繁复了，简单总结如下：
1. 一边做，一边解决了不少问题
2. 重新写了测试代码，分别在qemu和真板上面运行
3. 探索代码，取消了一些原定的但是与异步串口工作无关的开发方向

## 下周（后续）工作

在收集完真板的各种数据参数之后做了简单的分析，下周可能会做：
1. 当前异步串口驱动表现优秀，反而是真板线速成为了限制，评价为驱动是5g驱动，设备是2g设备，我现在是想探索dma方向
2. 等待另一个板子
